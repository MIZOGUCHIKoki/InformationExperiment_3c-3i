...
star = Screen('MakeTexture', MainWindow, imread('star.png')); % 
syuri = Screen('MakeTexture', MainWindow, imread('syuri.png')); % 
...
for block = 1:2
	...
	for trial = 1:nTrials
		...
		% 刺激提示
        %Screen('MakeTexture', MainWindow, stimulus);
        ...
        Screen('DrawText', MainWindow, feedbacks, ScreenRect(3)/2-offset*2, ScreenRect(4)/2-10);
       	Screen('Flip', MainWindow);
		WaitSecs(1);
