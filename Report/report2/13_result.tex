...
\begin{figure}[H]
    ...
    \begin{tabularx}{\textwidth}{p{.05\textwidth}CCC}
        ...
        \begin{minipage}{.25\textwidth}
            \centering
            \includegraphics[keepaspectratio,width=\textwidth]{../../Figures/08_14_img4-fft.pdf}
        \end{minipage}  &
        \begin{minipage}{.25\textwidth}
            \includegraphics[keepaspectratio,width=\textwidth]{../../Figures/08_15_img16-fft.pdf}
        \end{minipage} &
        \begin{minipage}{.25\textwidth}
            \includegraphics[keepaspectratio,width=\textwidth]{../../Figures/08_16_img64-fft.pdf}
        \end{minipage}                                  \\
        ...
        \end{minipage}                                                   &
        \begin{minipage}{.25\textwidth}
            \includegraphics[keepaspectratio,width=\textwidth]{../../Figures/08_24_img4-fft.pdf}
        \end{minipage}  &
        \begin{minipage}{.25\textwidth}
            \includegraphics[keepaspectratio,width=\textwidth]{../../Figures/08_25_img16-fft.pdf}
        \end{minipage} &
        \begin{minipage}{.25\textwidth}
            \includegraphics[keepaspectratio,width=\textwidth]{../../Figures/08_26_img64-fft.pdf}
        \end{minipage}                                  \\
    \end{tabularx}
