...
生成した画像に対して，閾値処理する．閾値処理する前後での画像比較，閾値による比較し，考察する．今回，閾値を\(64\)，\(128\)，\(192\)で実験する．\scall{\kadaiaf}\sref{src:05_06}．
\section{\result}
\begin{figure}[h]
    \centering
