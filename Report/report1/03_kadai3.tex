...
\purpose
ノコギリ波は，矩形波と同様周期関数である．ゆえにノコギリ波は\eqref{equ:フーリエ級数展開}で表すことができる．矩形波もノコギリ波も合成波である．\par
...
波形に高調波成分ごとにランダムな初期位相を与えるためには，繰り返し処理の都度\texttt{rand}関数を呼び出すと良い．（\srcref{src:ランダム初期位相}）
...
音量について，振幅と音量は比例する．初期位相を与えた場合，波形の振幅が大きくなるにもかかわらず，音量が小さくなることが分かった．この理由は今後の課題として調査したい．\par
また，実験結果からわかるように，矩形波やノコギリ波に初期位相を与えると，波形が滑らかになるとともに音も滑らかに知覚される．この相関も調査したい．\par