...
\begin{wrapfigure}{r}[0mm]{.3\textwidth}
    ...
    \begin{tikzpicture}[samples=300,domain=0:pi+1/8*pi]
        ...
        \draw[latex-latex](0,-1.7)--(pi/2,-1.7)node[midway,below]{\tiny うなりの周期\ \((T_0)\)};
...
\begin{figure}[h]
    ...
    \begin{minipage}{.48\textwidth}
        \includegraphics[keepaspectratio,width=\textwidth]{../../Figures/01_05_0.pdf}
        \caption{ガウス雑音の波形}
        \label{fig:ガウス雑音の波形}
    \end{minipage}
    \begin{minipage}{.48\textwidth}
        \includegraphics[keepaspectratio,width=\textwidth]{../../Figures/01_05_1.pdf}
        \caption{ヒストグラム}
        \label{fig:ヒストグラム}
    \end{minipage}
\end{figure}
