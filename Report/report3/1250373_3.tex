...
\usepackage{hyperref,graphics,graphicx,framed,subcaption,xcolor,color}
...
\newcommand{\rulebox}[2]{\hspace{.2em}{{\color{black}\rule{.8em}{.8em}}}\llap{{\color #1\rule{.7em}{.7em}}}\hspace{.1em}\texttt{#2}}
\newcommand{\kadai}[1]{\(\blacktriangleright\)\ \underline{#1}}
\makeatletter
...
\saythanks
\input{11_purpose.tex}
\input{12_method.tex}
\onecolumn
\input{13_result.tex}
\twocolumn
\input{14_consideration.tex}
\input{15_conclusion.tex}
\input{30_words.tex}
\bibliography{bib}
\onecolumn
