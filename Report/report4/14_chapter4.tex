...
\begin{multicols}{2}
    \begin{enumerate}
        ...
        \item ドライ電極を頭部に装着する．
        \item 電極（\texttt{Fz}，\texttt{Cz}，\texttt{Pz}，\texttt{P4}，\texttt{PO7}，\texttt{Oz}，\texttt{PO8}）を\figref{fig:電極の配置図}に従ってセットする．参照電極は耳たぶに，接地電極を額にセットする．
...
\begin{figure}[H]
    ...
    \end{minipage}
\end{figure}
\footnotetext[1]{KUT-LMS 課題説明資料（\url{https://lms.kochi-tech.ac.jp/pluginfile.php/209127/mod_resource/content/12/task0529.pdf}）より}
\section{\result}
