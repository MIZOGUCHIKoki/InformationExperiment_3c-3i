...
\usepackage{tikz,pgfplots,anyfontsize}
...
\title{{\normalsize 情報学群実験第3C/3i 実験レポート 第4回}\\ 視覚情報処理とデータ解析に関する実験}
...
\pagestyle{report}
\setcounter{page}{1}
\input{11_chapter1.tex}
\input{12_chapter2.tex}
\input{13_chapter3.tex}
\input{14_chapter4.tex}
\bibliography{bib}
